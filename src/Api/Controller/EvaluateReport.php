...
class EvaluateReport extends Controller {
    protected function post() {
        ...
        Database::execute('INSERT INTO comment_report_response (admin_id, comment_report_request_id, admin_note) VALUES(?,?,?)', [$this->userId, $this->data['reportID'], $this->data['responseMessage']]);
        $this->success();
    }
}

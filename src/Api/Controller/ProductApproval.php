...
class ProductApproval extends Controller {
    ...
    private function prepareRequest() {
        $this->request = Database::getRows('SELECT * FROM product_request pr INNER JOIN member m ON m.member_id=pr.member_id WHERE pr.cancelled=0 AND pr.product_request_answered=0 LIMIT 10');
        $this->reqArr = [];
